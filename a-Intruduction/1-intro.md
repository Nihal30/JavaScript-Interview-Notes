![a](https://user-images.githubusercontent.com/100460788/235360048-86873f6d-81bd-46ae-9537-13f650822233.jpg)
...
### `External JavaScript` : 
 We can create the file with a .js extension and paste the JS code inside of it. After creating the file, add this file in <script src=”file_name.js”> tag, and this <script> can import inside <head> or <body> tag of the HTML file.
